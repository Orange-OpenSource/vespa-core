...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Supervisor", pos = wx.DefaultPosition, size = wx.Size( 967,740 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		
		self.SetSizeHintsSz( wx.DefaultSize, wx.DefaultSize )
		
		self.MainMenu = wx.MenuBar( 0 )
		self.menuFicher = wx.Menu()
		self.m_menuItem1 = wx.MenuItem( self.menuFicher, wx.ID_ANY, u"Ouvrir Archi", wx.EmptyString, wx.ITEM_NORMAL )
		self.menuFicher.AppendItem( self.m_menuItem1 )
		
		self.m_menuItem2 = wx.MenuItem( self.menuFicher, wx.ID_ANY, u"Fermer Archi", wx.EmptyString, wx.ITEM_NORMAL )
		self.menuFicher.AppendItem( self.m_menuItem2 )
		
		self.menuFicher.AppendSeparator()
		
		self.m_menuItem3 = wx.MenuItem( self.menuFicher, wx.ID_ANY, u"Quitter", wx.EmptyString, wx.ITEM_NORMAL )
		...
		self.archiTree = wx.TreeCtrl( self, wx.ID_ANY, wx.DefaultPosition, wx.Size( 200,-1 ), wx.TR_DEFAULT_STYLE )
		gbSizer2.Add( self.archiTree, wx.GBPosition( 0, 0 ), wx.GBSpan( 1, 1 ), wx.EXPAND, 5 )
		
		self.m_notebook1 = wx.Notebook( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, 0 )
		self.InfoPanel = wx.Panel( self.m_notebook1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		bSizer7 = wx.BoxSizer( wx.VERTICAL )
		
		self.InfoGrid = wx.grid.Grid( self.InfoPanel, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.HSCROLL|wx.VSCROLL )
		...
		self.GlobalViewPanel = wx.Panel( self.m_notebook1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		#self.m_notebook1.AddPage( self.GlobalViewPanel, u"Vue globale", False )
		
		gbSizer2.Add( self.m_notebook1, wx.GBPosition( 0, 1 ), wx.GBSpan( 1, 1 ), wx.EXPAND, 5 )
		
		bSizer5.Add( gbSizer2, 1, wx.EXPAND, 5 )
		
		self.richTextConsole = wx.richtext.RichTextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( -1,200 ), 0|wx.VSCROLL|wx.WANTS_CHARS )
		...
		self.archiTree.Bind( wx.EVT_TREE_ITEM_RIGHT_CLICK, self.drawTreeItemMenu )
